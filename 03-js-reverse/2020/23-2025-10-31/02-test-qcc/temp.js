...
(function(_0x5de0a6) {
                ...
                if (_0x3a2ce3[_0x5176dc(526, "w3mj")](_0x3a2ce3[_0x5176dc(499, "AlDm")], "hOSHP")) {
                    ...
                    if (_0x3c85e0 == "==") {
                        if (_0x3a2ce3.Wioaw(_0x3a2ce3.EFFBQ, _0x5176dc(416, "4Cm0"))) {
                            if (_0x2a423d && _0x3a2ce3[_0x5176dc(136, "tZ&@")](_0x457ab6[_0x5176dc(153, "%ag0")], !![])) {} else {
                                _0x384ce2.headers = {
    ...
    var _0x581b82 = function(_0x39d167, _0x487903, _0x20b5ed, _0x160de7) {
        ...
        if (typeof _0x2a4c26 != _0x3a2ce3[_0x4323a7(314, "oi79")]) {
            if (_0x160de7 && _0x160de7[_0x4323a7(432, "4SGv")] == !![]) {} else {
...
!function(t, e) {
    ...
    function y(t, e, n, r, o, a) {
        ...
        e = e || it;
        var l, d, p, u, c, f, g, m, h, w, y, k, C, T, j, A, P, R, N, M, F, V, $, I, D, J, U, q, K, L, B = 0, H = "", W = e._lc || !1, Z = e.ctx, z = n || e.tmpl, G = "number" == typeof r && e.tmpl.bnds[r - 1];
        for ("tag" === t._is ? (l = t,
        t = l.tagName,
        r = l.tagCtxs,
    ...
    function J(t, e, n, r, i) {
        ...
        function s(s, l, d, c, g, x, b, w, y, k, C, T) {
            ...
            c = Kt),
            y = y || n && !i;
            var j, A, P, R = (l || n) && [[]], N = "", M = "", F = "", V = "", $ = "", E = "", O = "", I = "", S = !y && !g;
            d = d || (w = w || "#data",
            g),
            o(T),
            v = T + s.length,
        ...
        var l, d, p, u, c, f = gt.allowCode || e && e.allowCode || mt.allowCode === !0, g = [], v = 0, m = [], h = g, _ = [, , g];
    ...
    function B(t, e, n) {
        var r, i, o, a, s, l, d, p, u, c, f, g, v, m, h, _, x, b, w, y, k, C, T, j, A, P, R, N, F, V, $, E, O, I = 0, S = vt.useViews || e.useViews || e.tags || e.templates || e.helpers || e.converters, J = "", q = {}, L = t.length;
    ...
    function W(t, n) {
        var r, i, o, a = n.tag, s = n.props, l = n.params.props, d = s.filter, p = s.sort, u = p === !0, c = parseInt(s.step), f = s.reverse ? -1 : 1;
        if (!lt(t)) {
            return t;
        }
    ...
    var et = e === !1;
    e = e && e.fn ? e : t.jQuery;
    var nt, rt, it, ot, at, st, lt, dt, pt, ut, ct, ft, gt, vt, mt, ht, _t, xt, bt, wt, yt, kt, Ct = "v1.0.6", Tt = "_ocp", jt = /[ \t]*(\r\n|\n|\r)/g, At = /\\(['"])/g, Pt = /['"\\]/g, Rt = /(?:\x08|^)(onerror:)?(?:(~?)(([\w$.]+):)?([^\x08]+))\x08(,)?([^\x08]+)/gi, Nt = /^if\s/, Mt = /<(\w+)[>\s]/, Ft = /[\x00`><"'&=]/g, Vt = /[\x00`><\"'&=]/, $t = /^on[A-Z]|^convert(Back)?$/, Et = /^\#\d+_`[\s\S]*\/\d+_`$/, Ot = Ft, It = /[&<>]/g, St = /&(amp|gt|lt);/g, Dt = /\[['"]?|['"]?\]/g, Jt = 0, Ut = {
        "&": "&amp;",
        "<": "&lt;",
        ">": "&gt;",
        "\0": "&#0;",
        ...
        gt: ">",
        lt: "<"
    }, Kt = "html", Lt = "object", Bt = "data-jsv-tmpl", Qt = "jsvTmpl", Ht = "For #index in nested block use #getIndex().", Wt = {}, Zt = t.jsrender, zt = Zt && e && !e.render, Gt = {
        template: {
            compile: A
        },
        tag: {
    ...
    !(Zt || e && e.render)) {
        ...
        ct({
            ...
            "for": {
                ...
                render: function(t) {
                    var e, n, r, i, o, a = this, s = a.tagCtx, l = s.argDefault === !1, d = s.props, p = l || s.args.length, u = "", c = 0;
                    if (!a.rendering.done) {
...
$(function() {
    ...
    $.advert({
        ...
        fn: function(a, res) {
            console.log(res);
            $(".spotslider .loading").remove();
            $.qccimgLazy.init(".spotslider ul li img");
        }
    });
    $.qccpager.init({
        node: "#page",
            ...
            $.global.qccPirceLogin({
                fn: function(phtml) {
                    ...
                    node.find(pbox).each(function() {
                        if ($(this).find(".b-time").length > 0) {
                            $(this).siblings(".pirceLogin").append($(this).find(".b-time")[0].outerHTML);
                        }
                    });
